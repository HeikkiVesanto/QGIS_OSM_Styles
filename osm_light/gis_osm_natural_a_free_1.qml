...
<qgis simplifyAlgorithm="0" version="3.20.0-Odense" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingHints="1" simplifyLocal="1" labelsEnabled="0" readOnly="0">
  ...
  <renderer-v2 symbollevels="0" type="categorizedSymbol" forceraster="0" attr="fclass" enableorderby="0">
    <categories>
      <category symbol="0" render="true" label="beach" value="beach"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" alpha="1" type="fill" name="0" force_rhr="0">
        ...
        <layer locked="0" enabled="1" class="SimpleFill" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="180,180,180,255"/>

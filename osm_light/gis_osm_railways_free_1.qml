...
<qgis simplifyAlgorithm="0" version="3.20.0-Odense" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="100000000" simplifyDrawingHints="1" simplifyLocal="1" labelsEnabled="0" readOnly="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="0">
    <rules key="{5518f5c3-9d94-4cb0-9090-b74a7ec71d77}">
      <rule key="{6b3ff242-1213-4694-b4ec-92d408eae134}" symbol="0" scalemaxdenom="100000"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias name="" field="layer" index="4"/>
    <alias name="" field="bridge" index="5"/>
    <alias name="" field="tunnel" index="6"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" field="layer" unique_strength="0"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" field="bridge" unique_strength="0"/>
    <constraint exp_strength="0" constraints="0" notnull_strength="0" field="tunnel" unique_strength="0"/>
  </constraints>
